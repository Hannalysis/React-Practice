    ...
    <ReactCardFlip flipDirection = "horizontal" isFlipped = {isFlipped}>
        <div>
            <button className = "flashcard" 
                ...
                {/* // everything is the same apart from this data here and below, we use card.card.front to
                access the data - the naming convention should be better i agree haha */}
                {card.card.front}
            </button>
        </div>
        <div>
